...
public class PlacementManager : MonoBehaviour
{
    ...
    private void TryDestroyItem()
    {
        ...
        if (hit.collider != null)
        {
            ...
            if (item != null)
            {
                ...
                {
                    Debug.LogWarning("Nie mo¿na podnieœæ przedmiotu: jest w trakcie przenoszenia przez taœmoci¹g.");
                    return;
                }
                ...
                {
                    Debug.LogError("B³¹d: Nie znaleziono PlayerInventory.Instance! Przedmiot zosta³ usuniêty bez dodania do ekwipunku.");
                }
    ...
    private bool TryPlaceObjectAtPosition(Vector2Int gridPosition)
    {
        ...
        {
            if (!hasResources) Debug.LogWarning("Brak surowców do budowy!");
            return false;
        }
    ...
    private void TryRemoveBuilding()
    {
        ...
        {
            Debug.LogWarning($"Próba usuniêcia: Na polu {gridPosition.x}, {gridPosition.y} nie ma ¿adnego obiektu.");
            return;
        }
