...
public class MinerBuilding : GridObject
{
    ...
    void Update()
    {
        ...
        // Zawsze próbuj wyrzucać z bufora, gdy tylko pole przed minerem jest wolne.
        TryOutputFromBuffer();
        ...
        if (timer <= 0f)
        {
            ...
            // Po wydobyciu spróbuj od razu wypchnąć pierwszy element z bufora.
            TryOutputFromBuffer();
        }
    }
    ...
    private void TryOutputFromBuffer()
    {
        ...
        {
            // Gdy instantiate nie powiedzie się, pozostaw item w buforze i spróbuj ponownie.
        }
    }
    ...
    {
        // Zmieniamy na int, aby �atwo zapisa� Enum Direction
    ...
    public void RecalculateBoost()
    {
        ...
        Debug.Log($"[Miner {myPos}] Znaleziono ��cznie {totalExtenders} extender�w w sieci. Speed: {currentProductionSpeed}");
    }
    ...
    private int CountAllConnectedExtenders(Vector2Int currentPoint, HashSet<Vector2Int> visited)
    {
        ...
        {
            // Je�li ju� tu byli�my, skaczemy dalej
            ...
            if (extender != null && extender.GetTargetGridPosition() == currentPoint)
            {
                ...
                {
                    Debug.Log($"[Miner] Extender na {nPos} jest na innym z�o�u - ignoruj�.");
                }
            }
        }
        return count;
